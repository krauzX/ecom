...
type RouteParams = {  };
type RouteId = '/(app)/payment/success';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../node_modules/@sveltejs/kit/src/routes/(app)/payment/success/+page.server.js').load>>>>>>;
