...
type RouteParams = {  };
type RouteId = '/(app)/payment/process';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../node_modules/@sveltejs/kit/src/routes/(app)/payment/process/+page.server.js').load>>>>>>;
