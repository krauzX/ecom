...
type RouteParams = {  };
type RouteId = '/(app)/my/reviews/create';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../node_modules/@sveltejs/kit/src/routes/(app)/my/reviews/create/+page.server.js').load>>>>>>;
