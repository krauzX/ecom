...
type RouteParams = { pid: string };
type RouteId = '/(app)/my/wishlist/add/[pid]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../../node_modules/@sveltejs/kit/src/routes/(app)/my/wishlist/add/[pid]/+page.server.js').load>>>>>>;
