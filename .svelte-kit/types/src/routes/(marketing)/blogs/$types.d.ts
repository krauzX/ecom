...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../node_modules/@sveltejs/kit/src/routes/(marketing)/blogs/+page.server.js').load>>>>>>;
