...
type RouteId = '/(marketing)/blogs/[slug]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../node_modules/@sveltejs/kit/src/routes/(marketing)/blogs/[slug]/+page.server.js').load>>>>>>;
